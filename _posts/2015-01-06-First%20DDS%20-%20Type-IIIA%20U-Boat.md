...
excerpt: <img src="/images/flag_germany.jpg"/>Although never built, the German Type-IIIA submarine
  was to be the first designed with an integral dry deck shelter for smaller vessels.
  <a href="/First DDS - Type-IIIA U-Boat.html"><img src="/images/uboot_Type-IIIA_header.jpg"/></a>
...
...
[![](/images/uboot_Tp-IIIA_940.jpg)](/images/uboot_Tp-IIIA_2200.jpg)   
*Original artwork. CLICK for HIGH-RESOLUTION image.*   
  
![U-Boot](/images/uboot_Tp-IIIA_schematic.jpg)   
...
![SL-Boot](/images/uboot_Type-IIIA_SL-Boot1.jpg)   
*SL-Boot. Source [s-boot.net](http://s-boot.net/sboote-km-dat-ls7.html)   
Length: 12.5m  
Beam: 3.46m  
Weight: 11.5 tons  
Crew: 7   
...
Speed: 38ktsBuilder: Dornier-Werft, Friedrichshafen