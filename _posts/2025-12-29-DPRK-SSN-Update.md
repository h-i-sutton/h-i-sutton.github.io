...
*Kim Jong Un, the leader of North Korea, inspecting the submarine. He is seen walking beside the port-side of the sail with one of the missile silo doors above. Note the gap between this and the hydroplanes, indicating a single row of missiles with alternating port-starboard doors.*
