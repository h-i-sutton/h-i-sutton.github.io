...
The imagery used just happens to be available on Google Earth Pro. It is a Maxar image from March 13 2020. Therefore identifying the ships is relatively straightforward. (Actually I ID’d them from a screenshot of the show before I thought to check GE. Muppet, we live and learn!). Back in 2020 Russia’s Black Sea Fleet still had a KARA Class cruiser and KASHIN class destroyer moored in Sevastopol. These curious Cold War hangovers are visible on the imagery.   

The KARA has since been scrapped and the KASHIN has been moved to become a museum. The SLAVA Class cruiser Moskva, then the flagship of the Black Sea Fleet, is also just visible on the edge of the screenshot. That ship has since bneen sunk by Ukrainian Neptune anti-ship missiles on April 13-14 this year.   

Using this method we can say with confidence that the ship highlighted in the show is a Buyan-M missile corvette.   
