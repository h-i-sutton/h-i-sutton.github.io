...
![Flag North Korea](/images/flag_nork.jpg) North Korea unveils so many new missiles that it is hard to keep up. For submarine launched missiles, which are one of the key focuses, the trend has been bigger and bigger. Things have progressed from the Pukguksong-1 which was first shown in 2015, to the Pukguksong-5 [revealed earlier this year](http://www.hisutton.com{% post_url 2021-01-15-North-Korean-Navy-SLBM-Pukguksong-5 %}).   
