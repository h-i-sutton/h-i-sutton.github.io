...
![Flag China](/images/flag_China.jpg) The **JARI-USV-A Orca** (possibly also called 'Killer Tiger'), is a new large uncrewed combat vessel (USV - uncrewed surface vessel) developed in China. The design features a futuristic trimaran hull with a vertical launch system (VLS) for missiles and a helipad for UAVs at the stern. Perhaps more significantly, it features an integrated mast with multiple radar arrays, setting it apart from simpler combat USVs being developed elsewhere.  
