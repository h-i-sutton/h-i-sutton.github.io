...
#HistoryThe Trafalgar class were designed in the 1970s are an iterative improvement on the preceding Swiftsure Class. In keeping with Royal Navy tradition all 7 boats have named beginning with the same letter of the alphabet. Therefore they are informally known as the T-boats, as the Swiftsures were the S-boats. This tradition has been retained for the following Upholder Class, Vanguard and Astute Classes. But it will be broken by the future Dreadnought Class.   
