...
b) New Russian weapon systems, notably the [Poseidon]({% post_url 2019-02-22-Poseidon_Torpedo %}) Intercontinental Nuclear-Powered Nuclear-Armed Autonomous Torpedo and various unmanned underwater vehicles (UUVs) will be deep-diving threats. New weapons will need to be developed to [counter]({% post_url 2018-08-15-Countering_Russian_Poseidon_Torpedo %}) these.
...
1. & 2. early concept artworks of FASM, now dated. 3. BAE Systems image of Dreadnought Class SSBN  

##SizeThe SSN(R) will be roughly 25% larger than the Astute Class due to the newer machinery borrowed from the Dreadnought, a the need to carry more extensive torpedo defenses.   
