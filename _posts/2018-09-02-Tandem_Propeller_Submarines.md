...
1.[![](/images/Cigar_Ship_h150.jpg)](/images/Cigar_Ship.jpg)

2.[![](/images/USS_Albacore_stern_h150.jpg)](/images/USS_Albacore_stern.jpg)

3.[![](/images/Swe_A11_1956_h150.jpg)](/images/A11_1956.jpg)

  

  

>1. First built in 1858, the Winans’ *Cigar Ships* featured a wrap-around propeller amidships, similar in some respects to the one proposed for submarines. The Inventor, Ross Winans was from a family of successful railway engineers from Baltimore, Maryland. Good source [vernianera.com](http://www.vernianera.com/CigarBoats.html).  

>2. The USS Albacore was a testbed for a number of hydrodynamic experiments. In its final configuration it featured a contra-rotating tandem propeller and X0form rudders. It is now a museum ship.  

>3. The [Swedish A11 submarine program](http://www.hisutton.com{% post_url 2022-02-03-Swedish_SSN %}) was heavily influenced by access to the USS Albacore. This early plan shows a submarine without conventional tail surfaces, instead using the propeller for steering. It has large wing-like hydroplanes forward and a rudder on the trailing edge of the sail. The A-11 program explored nuclear propulsion as well but ultimately settled on a conventional boat, albeit with cutting edge X-form control surfaces.  
...
Cdr. Frederick R. **Haselton**, US Navy, conceived that a submarine can operate with just two propellers, without the need for rudders or hydroplanes. It can move in almost any direction, including backwards, by subtly directing the thrust from the propellers. The system would not be quite as fast as regular submarines with more conventional propulsion by a couple of knots, but it would be more agile. Haselton also determined that a tandem propeller submarine would be able to operate deeper than regular submarines but would also displace significantly more for the same dimension parameters. Good Reference: [Atomic Submarines](https://www.amazon.com/Atomic-Submarines-Norman-Polmar/dp/B0000CLYQG/) by Norman Polmar, 1963.  

![Tandem_Propeller_Submarines - Covert Shores](/images/Tandem-Propeller-Sub4_b.jpg)   

![Tandem_Propeller_Submarines - Covert Shores](/images/Tandem-Propeller-Sub4.jpg)   
...
![Tandem_Propeller_Submarines - Covert Shores](/images/Tandem-Propeller-Sub3.jpg)   

![Tandem_Propeller_Submarines - Covert Shores](/images/Tandem-Propeller-Sub2.jpg)   
...
![Tandem_Propeller_Submarines - Covert Shores](/images/Tandem-Propeller-Sub1.jpg)   
...
1.[![](/images/US_ForwardPass_boat_h150.jpg)](/images/US_ForwardPass_boat.jpg)

2.[![](/images/KSS500_h150.jpg)](/images/KSS500_1800.jpg)

  

  

>1. In the early 2000s a ‘Forward PASS’ (Forward Payloads and Sensors for Submarines consortium), led by Raytheon and supported by Electric Boat, proposed new-generation submarines incorporating an aft-mounted payload bay which exited the submarine through the center of a wrap-around propeller. In this case the propeller itself was buried within the aft hull.   

>2. The South Korean [HDS-500](http://www.hisutton.com{% post_url 2015-09-27-News%20-%20Korea%20building%20new%20HDS-400%20midget%20submarine %}) design features an integrated wrap-around pumpjet with a mini wet-dry hangar in the tail.  
