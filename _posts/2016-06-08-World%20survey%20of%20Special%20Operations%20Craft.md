...
The Turkish Navy’s MRTP-22U Special Forces craft are broadly equivalent of the US Navy’s CCM. Two were ordered in 2008 to and are operated in support of SAT (Sualtı Taarruz Komutanlığı), and there is an open requirement for two more (or of an equivalent type).

The craft features a very large working deck with open transom and ramp, allowing two eight-man powered inflatables to be operated simultaneously. When onboard the sixteen commandos are provided with shock-absorbent seats.   
