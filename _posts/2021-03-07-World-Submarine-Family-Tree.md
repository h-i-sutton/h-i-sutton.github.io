...
[![](/images/World-Submarine-Family-Tree-940.jpg)](/images/World-Submarine-Family-Tree.jpg)  
*Click for high resolution.*  

# World Submarines Family Tree

I would like to share this resource I built as part of my research into submarine design history. Similar to my Narco Submarine Taxonomy ([book here](https://www.amazon.com/Narco-Submarines-Covert-Shores-Recognition/dp/B086G11WMM/)), I am trying to make map out which designs influenced which others. And from there which designs can be said to be the [most influential submarines]({% post_url 2021-03-03-5-most-influential-submarine-designs-ever %}). This is a nuanced topic and the map is only intended as a starting point.   

Sometimes the relationships between designs are plain for all to see, such as the follow-on classes. Other times the influences were clear because we know that the designers of one boat were inspired by designs elsewhere. For example the Swedish Sjöormen Class benefited from access to the USS Albacore. And other times the influence is inferred (shown as weaker links on the chart).   
...
Hopefully this is interesting and useful. I hope to do a poster version (my store [is at TeeSpring](https://teespring.com/stores/covert-shores)), once I have reflected on any corrections which might be needed. Feedback welcome.   
