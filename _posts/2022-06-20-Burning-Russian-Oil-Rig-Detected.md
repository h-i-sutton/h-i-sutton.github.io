...
[![](/images/Russia-Ukraine-Attack-Oil-Rig-NASA-940.jpg)](/images/Russia-Ukraine-Attack-Oil-Rig-NASA.jpg)  
*CLICK to Enlarge*.  

#NASA Detects Burning Russian Controlled Oil Platform After Ukrainian Attack![Flag Russia](/images/flag_russia.jpg) Ukraine attacked oil platforms controlled by Russia today. The three platforms, east of the now-famous Snake Island, are near where the cruiser Moskva was sunk in April. And the Navy tug Vasily Bekh on June 17.   
...
![Russian Controlled Oil Platform After Ukrainian Attack](/images/Russia-Ukraine-Rig.jpg)  
*Reference image of one of te rigs, Tavrida, with a Russian Navy TARANTUL-III missile boat. Source [informnapalm.org](https://informnapalm.org/en/russia-operates-captured-ukrainian-oil-rigs-in-ukraines-exclusive-economic-zone/)*  
...
NASA's Worldview imagery has a [fire detection filter](https://worldview.earthdata.nasa.gov/?v=30.28609463002277,45.100046995317356,31.43529694743769,45.66088166793078&l=MODIS_Combined_Thermal_Anomalies_All,VIIRS_SNPP_Thermal_Anomalies_375m_All,VIIRS_NOAA20_Thermal_Anomalies_375m_All,Reference_Labels_15m(hidden),Reference_Features_15m(hidden),Coastlines_15m(hidden),VIIRS_NOAA20_CorrectedReflectance_TrueColor(hidden),VIIRS_SNPP_CorrectedReflectance_TrueColor(hidden),MODIS_Aqua_CorrectedReflectance_TrueColor,MODIS_Terra_CorrectedReflectance_TrueColor&lg=false&t=2022-06-20-T16%3A34%3A51Z). This is used for tracking wild fires and similar peaceful activities. In the war it has also revealed the location of fighting. It shows up the burning rig.   
...
[![](/images/Russia-Crimea=June20-940.jpg)](/images/Russia-Crimea=June20.jpg)  
*CLICK to Enlarge*.  
